...
<div class=py-12>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <div class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-4 shadow-md my-3">
                <div class="flex">
                    <div class="">
                        <p class="text-sm">
                            {{ session('message') }}
                    ...
                    @foreach ($posts as $post)
                       <tr>
                        ...
                        <td class="border px-4 py-2">
                            ...
                            <button wire:click='edit({{$post->id}})' class="bg-red-500 hover:bg-bl-red-700 text-white font-bold py-2 px-4 rounded">
                                Delete
                            </button>
                        </td>
                       </tr>
